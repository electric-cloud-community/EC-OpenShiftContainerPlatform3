...
package FlowPlugin::ECOpenShiftContainerPlatform3RESTClient;
use strict;
use warnings;
use LWP::UserAgent;
use JSON;
...
use FlowPDF::Log;
## DO NOT EDIT THIS BLOCK === rest client imports ends, checksum: 973cef2ea4a3855f9e68b4561f57ea6b ===
# Place for the custom user imports, e.g. use File::Spec
## DO NOT EDIT THIS BLOCK === rest client starts ===
=head1

FlowPlugin::ECOpenShiftContainerPlatform3RESTClient->new('http://endpoint', {
...
use constant {
    ...
    USER_AGENT => 'ECOpenShiftContainerPlatform3RESTClient REST Client',
...
Use this method to create a new FlowPlugin::ECOpenShiftContainerPlatform3RESTClient, e.g.

    my $client = FlowPlugin::ECOpenShiftContainerPlatform3RESTClient->new($endpoint,
...
sub getARouteInANamespace {
    ...
    $self->{method} = 'getARouteInANamespace';
    $self->{methodParameters} = \%params;

    my $uri = "/apis/route.openshift.io/v1/namespaces/{{namespace}}/routes/{{name}}";
...
sub PatchADeploymentInANamespace {
    ...
    $self->{method} = 'PatchADeploymentInANamespace';
    $self->{methodParameters} = \%params;
...
sub PatchADeploymentConfigInANamespace {
    ...
    $self->{method} = 'PatchADeploymentConfigInANamespace';
    $self->{methodParameters} = \%params;
...
sub PatchARouteInANamespace {
    ...
    $self->{method} = 'PatchARouteInANamespace';
    $self->{methodParameters} = \%params;
...
## DO NOT EDIT THIS BLOCK === rest client ends, checksum: 48fad539d88d1125ed9fa8cebbc6f05d ===
=pod
